          ...
          <div class="box box-primary">
            ...
            <form role="form" action="" method="POST">
              ...
              <div class="form-group">
                <label>Função</label>
                <select class="form-control select2" name="nome" style="width: 100%;">
...
$sql = "SELECT funcao FROM funcionario WHERE  email='$email'";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
  echo "Email já existente";
} else {
  $sql = "INSERT INTO funcionario (funcao, email, senha)
